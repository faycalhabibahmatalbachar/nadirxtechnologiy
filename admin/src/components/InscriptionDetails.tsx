...
import { X, Download, MapPin, Phone, Calendar, Briefcase, Code, Edit2, Save } from 'lucide-react';
      ...
      <div className="bg-surface border border-border/30 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto my-8">
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="border border-primary/30 rounded-lg p-4 bg-primary/5">
              ...
              <div className="w-full flex justify-center mb-3">
                <img
                  src={photoUrl}
                  alt="Photo"
                  className="w-64 aspect-square object-contain rounded border border-border/30 bg-surface/30"
                />
              </div>
              <button
          ...
          <div className="border border-border/30 rounded-lg p-4 bg-surface/30">
            <h3 className="text-xs font-bold font-mono text-primary mb-4">ADMINISTRATION</h3>
